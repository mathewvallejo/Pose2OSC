...
recent hand window, and writes those samples to the manifest immediately. Each
capture stores up to 64 frames by default, keeping KNN fast while still
capturing small variations in the performer's held pose.
